...
function corel4Link() {
  ...
  let url = "http://18.139.62.80:8080/corel4/" + cachedUuid + "/" + spreadsheetId + "/" + sheetId;
...
function aasvgLink() {
  ...
  let sheetId = 0;
  [spreadsheetId, sheetId] = getSsid();
  let url = "http://18.139.62.80:8080/aasvg/" + cachedUuid + "/" + spreadsheetId + "/" + sheetId;
...
function jsonLink() {
  ...
  let sheetId = 0;
  [spreadsheetId, sheetId] = getSsid();
  let url = "http://18.139.62.80:8080/json/" + cachedUuid + "/" + spreadsheetId + "/" + sheetId;
